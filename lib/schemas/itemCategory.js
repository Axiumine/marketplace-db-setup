...
//
// **Two levels, and only an operator may write one.** A document with no `idParent` is a category;
 ...
 *
 * `position` is a SORT ORDINAL — an integer the operator reorders the menu with — and is **not** the
