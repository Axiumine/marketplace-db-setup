// The `admin` validator — the platform admin, the smallest of the three collections you
...
// admin), no `emailVerify` (the account is created by hand), no `registeredAt`.
//
 ...
 * there is no admin table over the admins, and the Admin tier reads its own document by `_id`.
