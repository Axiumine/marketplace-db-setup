 ...
 * account holder closed their own account; `deleted` *with* one means an admin did, and the value is
 ...
 * and an admin's decision would then be told apart by comparing two ObjectIds instead of by looking.
 */
const DELETED_BY = {
  bsonType: 'objectId',
...
/**
 * Why the account was suspended, in the admin's own words.
 *
